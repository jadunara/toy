...
/*****
 * https://github.com/profesorfalken/jPowerShell/blob/master/src/test/java/com/profesorfalken/jpowershell/PowerShellTest.java
 * 
...
//	    public final ExpectedException exception = ExpectedException.none();
	    ...
	    public static void main(String[] args) {
	    	String command = "lsx";
			String result = TestPowerShell.executeCommand( command  );
...
//	            config.put("maxWait", "20000");
	            ...
	            if (psResponse.isError()) {
	                throw new Exception(" operation finished in error: "+ psResponse.getCommandOutput());
	            }
...
////	        if (OSDetector.isWindows()) {
//	        PowerShellResponseHandler res;
//			System.out.println("List Processes:" + res.getCommandOutput());
//	            PowerShell.openSession()
//	                    .executeCommandAndChain("Get-Process", (res ));
//;
